...
# https://stackoverflow.com/questions/21440363/extracting-the-number-of-days-from-a-calculated-interval
...
all_queries_str = (
    ...
    "ALTER TABLE id_new_day "
    "ADD COLUMN id_item_cnt_sale_dts_before_day int, "
    "ADD COLUMN id_item_cnt_sale_dts_last_7d smallint, "
    "ADD COLUMN id_item_cnt_sale_dts_last_30d smallint; "
    ...
    "UPDATE id_new_day "
    "SET id_item_cnt_sale_dts_before_day = 0 "
    "WHERE id_item_cnt_sale_dts_before_day IS NULL; "
    "UPDATE id_new_day "
    "SET id_item_cnt_sale_dts_last_7d = 0 "
    "WHERE id_item_cnt_sale_dts_last_7d IS NULL; "
    "UPDATE id_new_day "
    "SET id_item_cnt_sale_dts_last_30d = 0 "
    "WHERE id_item_cnt_sale_dts_last_30d IS NULL; "
    # quantity sold 1, 2, 3, 7 days ago
    "ALTER TABLE id_new_day "
    "ADD COLUMN id_item_qty_sold_1d_ago smallint, "
    "ADD COLUMN id_item_qty_sold_2d_ago smallint, "
    "ADD COLUMN id_item_qty_sold_3d_ago smallint, "
    "ADD COLUMN id_item_qty_sold_7d_ago smallint; "
    "UPDATE id_new_day nd "
    ...
    "UPDATE id_new_day "
    "SET id_item_qty_sold_1d_ago = 0 "
    "WHERE id_item_qty_sold_1d_ago IS NULL; "
    "UPDATE id_new_day "
    "SET id_item_qty_sold_2d_ago = 0 "
    "WHERE id_item_qty_sold_2d_ago IS NULL; "
    "UPDATE id_new_day "
    "SET id_item_qty_sold_3d_ago = 0 "
    "WHERE id_item_qty_sold_3d_ago IS NULL; "
    "UPDATE id_new_day "
    "SET id_item_qty_sold_7d_ago = 0 "
    "WHERE id_item_qty_sold_7d_ago IS NULL; "
    # days since first and previous sale
    "ALTER TABLE id_new_day "
    "ADD COLUMN id_item_days_since_first_sale int, "
    "ADD COLUMN id_item_days_since_prev_sale smallint; "
    "UPDATE id_new_day nd "
    ...
    "FROM ("
    "SELECT item_id, %(curr_date)s - min(sale_date)::date AS id_item_days_since_first_sale, "
    # "SELECT item_id, extract(day from %(curr_date)s - min(sale_date)) AS id_item_days_since_first_sale, "
    "%(curr_date)s - (max(sale_date) FILTER (WHERE id_item_qty_sold_day > 0))::date AS id_item_days_since_prev_sale "
    # "extract(day from %(curr_date)s - max(sale_date) FILTER (WHERE id_item_qty_sold_day > 0)) AS id_item_days_since_prev_sale "
    "FROM item_dates "
    "GROUP BY item_id) pd "
    "WHERE nd.item_id = pd.item_id; "
    "UPDATE id_new_day "
    "SET id_item_days_since_first_sale = 0 "
    "WHERE id_item_days_since_first_sale IS NULL; "
    "UPDATE id_new_day "
    "SET id_item_days_since_prev_sale = 0 "
    "WHERE id_item_days_since_prev_sale IS NULL; "
    # first month and first week flags
    "ALTER TABLE id_new_day "
    "ADD COLUMN id_item_first_month smallint, "
    "ADD COLUMN id_item_first_week smallint; "
    "UPDATE id_new_day nd "
    ...
    "UPDATE id_new_day "
    "SET id_item_first_month = 0 WHERE id_item_first_month IS NULL; "
    "UPDATE id_new_day "
    "SET id_item_first_week = 0 WHERE id_item_first_week IS NULL; "
    ...
    "ALTER TABLE id_new_day "
    "ADD COLUMN id_item_expand_qty_max smallint, "
    "ADD COLUMN id_item_expand_qty_mean real, "
    "ADD COLUMN id_item_expand_qty_min smallint, "
    "ADD COLUMN id_item_expand_qty_mode smallint, "
    "ADD COLUMN id_item_expand_qty_median real; "
    "UPDATE id_new_day nd "
    ...
    "avg(id_item_qty_sold_day) AS id_item_expand_qty_mean, "
    ...
    "UPDATE id_new_day "
    "SET id_item_expand_qty_max = 0 WHERE id_item_expand_qty_max IS NULL; "
    "UPDATE id_new_day "
    "SET id_item_expand_qty_mean = 0 WHERE id_item_expand_qty_mean IS NULL; "
    "UPDATE id_new_day "
    "SET id_item_expand_qty_min = 0 WHERE id_item_expand_qty_min IS NULL; "
    "UPDATE id_new_day "
    "SET id_item_expand_qty_mode = 0 WHERE id_item_expand_qty_mode IS NULL; "
    "UPDATE id_new_day "
    "SET id_item_expand_qty_median = 0 WHERE id_item_expand_qty_median IS NULL; "
    # gap between sales stats
    "ALTER TABLE id_new_day "
    "ADD COLUMN id_item_date_avg_gap_bw_sales real, "
    "ADD COLUMN id_item_date_max_gap_bw_sales smallint, "
    "ADD COLUMN id_item_date_min_gap_bw_sales smallint, "
    "ADD COLUMN id_item_date_median_gap_bw_sales real, "
    "ADD COLUMN id_item_date_mode_gap_bw_sales smallint, "
    "ADD COLUMN id_item_date_std_gap_bw_sales real; "
    "UPDATE id_new_day nd "
    ...
    "UPDATE id_new_day "
    "SET id_item_date_avg_gap_bw_sales = 0 WHERE id_item_date_avg_gap_bw_sales IS NULL; "
    "UPDATE id_new_day "
    "SET id_item_date_max_gap_bw_sales = 0 WHERE id_item_date_max_gap_bw_sales IS NULL; "
    "UPDATE id_new_day "
    "SET id_item_date_min_gap_bw_sales = 0 WHERE id_item_date_min_gap_bw_sales IS NULL; "
    "UPDATE id_new_day "
    "SET id_item_date_median_gap_bw_sales = 0 WHERE id_item_date_median_gap_bw_sales IS NULL; "
    "UPDATE id_new_day "
    "SET id_item_date_mode_gap_bw_sales = 0 WHERE id_item_date_mode_gap_bw_sales IS NULL; "
    "UPDATE id_new_day "
    "SET id_item_date_std_gap_bw_sales = 0 WHERE id_item_date_std_gap_bw_sales IS NULL; "
    # rolling 7-day quantity sold stats
    "ALTER TABLE id_new_day "
    "ADD COLUMN id_item_rolling_7d_avg_qty real, "
    "ADD COLUMN id_item_rolling_7d_max_qty smallint, "
    "ADD COLUMN id_item_rolling_7d_min_qty smallint, "
    "ADD COLUMN id_item_rolling_7d_median_qty real, "
    "ADD COLUMN id_item_rolling_7d_mode_qty smallint; "
    "UPDATE id_new_day nd "
    ...
    "UPDATE id_new_day "
    "SET id_item_rolling_7d_avg_qty = 0 WHERE id_item_rolling_7d_avg_qty IS NULL; "
    "UPDATE id_new_day "
    "SET id_item_rolling_7d_max_qty = 0 WHERE id_item_rolling_7d_max_qty IS NULL; "
    "UPDATE id_new_day "
    "SET id_item_rolling_7d_min_qty = 0 WHERE id_item_rolling_7d_min_qty IS NULL; "
    "UPDATE id_new_day "
    "SET id_item_rolling_7d_median_qty = 0 WHERE id_item_rolling_7d_median_qty IS NULL; "
    "UPDATE id_new_day "
    "SET id_item_rolling_7d_mode_qty = 0 WHERE id_item_rolling_7d_mode_qty IS NULL; "
    # number of unique shops prior to day
    # in the train data, this column is 'float32', but it could be integer
    "ALTER TABLE id_new_day "
    "ADD COLUMN id_num_unique_shops_prior_to_day real; "
    "UPDATE id_new_day nd "
    ...
    "UPDATE id_new_day "
    "SET id_num_unique_shops_prior_to_day = 0 WHERE id_num_unique_shops_prior_to_day IS NULL; "
    # number of spikes before day
    "ALTER TABLE id_new_day "
    "ADD COLUMN id_item_n_spikes_before_day smallint; "
    "UPDATE id_new_day nd "
    ...
    "UPDATE id_new_day "
    "SET id_item_n_spikes_before_day = 0 WHERE id_item_n_spikes_before_day IS NULL; "
    ...
    # last quantity sold
    "ALTER TABLE id_new_day "
    "ADD COLUMN id_item_last_qty_sold smallint; "
    "UPDATE id_new_day nd "
    ...
    "UPDATE id_new_day "
    "SET id_item_last_qty_sold = 0 WHERE id_item_last_qty_sold IS NULL; "
    # expanding average demand interval (ADI)
    "ALTER TABLE id_new_day "
    "ADD COLUMN id_item_expanding_adi real; "
    "UPDATE id_new_day "
    ...
    "UPDATE id_new_day "
    "SET id_item_expanding_adi = 0 WHERE id_item_expanding_adi IS NULL; "
    # expanding CV2 of quantity sold
    "ALTER TABLE id_new_day "
    "ADD COLUMN id_expand_cv2_of_qty real; "
    "UPDATE id_new_day nd "
    ...
    "UPDATE id_new_day "
    "SET id_expand_cv2_of_qty = 0 WHERE id_expand_cv2_of_qty IS NULL; "
    # days since max quantity sold
    "ALTER TABLE id_new_day "
    "ADD COLUMN id_days_since_max_qty_sold int; "
    "UPDATE id_new_day nd "
    "SET id_days_since_max_qty_sold = dsm.id_days_since_max_qty_sold "
    "FROM ("
    "SELECT item_id, %(curr_date)s - sale_date::date AS id_days_since_max_qty_sold "
    "FROM item_dates "
    ...
    "UPDATE id_new_day "
    "SET id_days_since_max_qty_sold = 0 WHERE id_days_since_max_qty_sold IS NULL; "
    # difference between last and previous quantities sold
    "ALTER TABLE id_new_day "
    "ADD COLUMN id_item_date_diff_bw_last_and_prev_qty smallint; "
    "WITH rns AS "
    ...
    "UPDATE id_new_day "
    "SET id_item_date_diff_bw_last_and_prev_qty = 0 WHERE id_item_date_diff_bw_last_and_prev_qty IS NULL; "
    # category quantity sold last 7 days
    "ALTER TABLE id_new_day "
    "ADD COLUMN id_cat_qty_sold_last_7d smallint; "
    "WITH ics AS "
    ...
    "UPDATE id_new_day "
    "SET id_cat_qty_sold_last_7d = 0 WHERE id_cat_qty_sold_last_7d IS NULL; "
    # number of items with positive quantity sold in last 7 days, by category
    "ALTER TABLE id_new_day "
    "ADD COLUMN id_cat_unique_items_sold_last_7d int; "
    "WITH ics AS "
    "(SELECT DISTINCT item_id, id_item_category_id "
    "FROM item_dates), "
    "cis AS "
    ...
    "WHERE nd.item_id = jt.item_id; "
    "UPDATE id_new_day "
    "SET id_cat_unique_items_sold_last_7d = 0 WHERE id_cat_unique_items_sold_last_7d IS NULL; "
    # quantity sold per item in category in the last week
    "ALTER TABLE id_new_day "
    "ADD COLUMN id_cat_qty_sold_per_item_last_7d real; "
    "UPDATE id_new_day "
    ...
    "UPDATE id_new_day "
    "SET id_cat_qty_sold_per_item_last_7d = 0 WHERE id_cat_qty_sold_per_item_last_7d IS NULL; "
    ...
    # counts of sale dates
    "ALTER TABLE sd_new_day "
    "ADD COLUMN sd_shop_cnt_sale_dts_before_day int, "
    "ADD COLUMN sd_shop_cnt_sale_dts_last_7d smallint, "
    "ADD COLUMN sd_shop_cnt_sale_dts_last_30d smallint; "
    ...
    # quantity sold 1, 2, 3, 7 days ago
    "ALTER TABLE sd_new_day "
    "ADD COLUMN sd_shop_qty_sold_1d_ago smallint, "
    "ADD COLUMN sd_shop_qty_sold_2d_ago smallint, "
    "ADD COLUMN sd_shop_qty_sold_3d_ago smallint, "
    "ADD COLUMN sd_shop_qty_sold_7d_ago smallint; "
    "UPDATE sd_new_day nd "
    ...
    # days since first and previous sale
    "ALTER TABLE sd_new_day "
    "ADD COLUMN sd_shop_days_since_first_sale int, "
    "ADD COLUMN sd_shop_days_since_prev_sale int; "
    "UPDATE sd_new_day nd "
    ...
    "FROM ("
    "SELECT shop_id, %(curr_date)s - min(sale_date)::date AS sd_shop_days_since_first_sale, "
    # "SELECT shop_id, extract(day from %(curr_date)s - min(sale_date)) AS sd_shop_days_since_first_sale, "
    "%(curr_date)s - (max(sale_date) FILTER (WHERE sd_shop_qty_sold_day > 0))::date AS sd_shop_days_since_prev_sale "
    # "extract(day from %(curr_date)s - max(sale_date) FILTER (WHERE sd_shop_qty_sold_day > 0)) AS sd_shop_days_since_prev_sale "
    "FROM shop_dates "
    "GROUP BY shop_id) pd "
    "WHERE nd.shop_id = pd.shop_id; "
    # first month and first week flags
    "ALTER TABLE sd_new_day "
    "ADD COLUMN sd_shop_first_month smallint, "
    "ADD COLUMN sd_shop_first_week smallint; "
    "UPDATE sd_new_day nd "
    ...
    "ADD COLUMN sd_shop_expand_qty_mean real, "
    "ADD COLUMN sd_shop_expand_qty_min smallint, "
    "ADD COLUMN sd_shop_expand_qty_mode int, "
    "ADD COLUMN sd_shop_expand_qty_median real; "
    "UPDATE sd_new_day nd "
    ...
    "avg(sd_shop_qty_sold_day) AS sd_shop_expand_qty_mean, "
    ...
    # gap between sales stats
    "ALTER TABLE sd_new_day "
    "ADD COLUMN sd_shop_date_avg_gap_bw_sales real, "
    "ADD COLUMN sd_shop_date_max_gap_bw_sales int, "
    "ADD COLUMN sd_shop_date_min_gap_bw_sales smallint, "
    "ADD COLUMN sd_shop_date_median_gap_bw_sales real, "
    "ADD COLUMN sd_shop_date_mode_gap_bw_sales smallint, "
    "ADD COLUMN sd_shop_date_std_gap_bw_sales real; "
    "UPDATE sd_new_day nd "
    ...
    # rolling 7-day quantity sold stats
    "ALTER TABLE sd_new_day "
    "ADD COLUMN sd_shop_rolling_7d_avg_qty real, "
    "ADD COLUMN sd_shop_rolling_7d_max_qty int, "
    "ADD COLUMN sd_shop_rolling_7d_min_qty smallint, "
    "ADD COLUMN sd_shop_rolling_7d_median_qty real, "
    "ADD COLUMN sd_shop_rolling_7d_mode_qty int; "
    "UPDATE sd_new_day nd "
    ...
    "ALTER TABLE sd_new_day "
    "ADD COLUMN sd_num_unique_items_prior_to_day int; "
    "UPDATE sd_new_day nd "
    ...
    # last quantity sold
    "ALTER TABLE sd_new_day "
    "ADD COLUMN sd_shop_last_qty_sold smallint; "
    "UPDATE sd_new_day nd "
    ...
    # difference between last and previous quantities sold
    "ALTER TABLE sd_new_day "
    "ADD COLUMN sd_shop_date_diff_bw_last_and_prev_qty smallint; "
    "WITH rns AS "
    ...
    "ALTER TABLE sd_new_day "
    "ADD COLUMN sd_num_unique_item_cats_prior_to_day smallint; "
    "WITH icc AS "
    ...
    # counts of sale dates
    "ALTER TABLE sid_new_day "
    "ADD COLUMN sid_shop_item_cnt_sale_dts_before_day int, "
    "ADD COLUMN sid_shop_item_cnt_sale_dts_last_7d smallint, "
    "ADD COLUMN sid_shop_item_cnt_sale_dts_last_30d smallint; "
    ...
    "UPDATE sid_new_day "
    "SET sid_shop_item_cnt_sale_dts_before_day = 0 WHERE sid_shop_item_cnt_sale_dts_before_day IS NULL; "
    "UPDATE sid_new_day "
    "SET sid_shop_item_cnt_sale_dts_last_7d = 0 WHERE sid_shop_item_cnt_sale_dts_last_7d IS NULL; "
    "UPDATE sid_new_day "
    "SET sid_shop_item_cnt_sale_dts_last_30d = 0 WHERE sid_shop_item_cnt_sale_dts_last_30d IS NULL; "
    # quantity sold 1, 2, 3, 7 days ago
    "ALTER TABLE sid_new_day "
    "ADD COLUMN sid_shop_item_qty_sold_1d_ago smallint, "
    "ADD COLUMN sid_shop_item_qty_sold_2d_ago smallint, "
    "ADD COLUMN sid_shop_item_qty_sold_3d_ago smallint, "
    "ADD COLUMN sid_shop_item_qty_sold_7d_ago smallint; "
    "UPDATE sid_new_day nd "
    ...
    "UPDATE sid_new_day "
    "SET sid_shop_item_qty_sold_1d_ago = 0 WHERE sid_shop_item_qty_sold_1d_ago IS NULL; "
    "UPDATE sid_new_day "
    "SET sid_shop_item_qty_sold_2d_ago = 0 WHERE sid_shop_item_qty_sold_2d_ago IS NULL; "
    "UPDATE sid_new_day "
    "SET sid_shop_item_qty_sold_3d_ago = 0 WHERE sid_shop_item_qty_sold_3d_ago IS NULL; "
    "UPDATE sid_new_day "
    "SET sid_shop_item_qty_sold_7d_ago = 0 WHERE sid_shop_item_qty_sold_7d_ago IS NULL; "
    # days since first and previous sale
    "ALTER TABLE sid_new_day "
    "ADD COLUMN sid_shop_item_days_since_first_sale int, "
    "ADD COLUMN sid_shop_item_days_since_prev_sale smallint; "
    "UPDATE sid_new_day nd "
    ...
    "SELECT shop_id, item_id, "
    "%(curr_date)s - min(sale_date)::date AS sid_shop_item_days_since_first_sale, "
    # "extract(day from %(curr_date)s - min(sale_date)) AS sid_shop_item_days_since_first_sale, "
    "%(curr_date)s - max(sale_date)::date AS sid_shop_item_days_since_prev_sale "
    # "extract(day from %(curr_date)s - max(sale_date)) AS sid_shop_item_days_since_prev_sale "
    "FROM sales_cleaned "
    "WHERE item_cnt_day > 0 "
    "GROUP BY shop_id, item_id) pd "
    "WHERE nd.shop_id = pd.shop_id AND nd.item_id = pd.item_id; "
    "UPDATE sid_new_day "
    "SET sid_shop_item_days_since_first_sale = 0 WHERE sid_shop_item_days_since_first_sale IS NULL; "
    "UPDATE sid_new_day "
    "SET sid_shop_item_days_since_prev_sale = 0 WHERE sid_shop_item_days_since_prev_sale IS NULL; "
    # first month and first week flags
    "ALTER TABLE sid_new_day "
    "ADD COLUMN sid_shop_item_first_month smallint, "
    "ADD COLUMN sid_shop_item_first_week smallint; "
    "UPDATE sid_new_day nd "
    ...
    "UPDATE sid_new_day "
    "SET sid_shop_item_first_month = 0 WHERE sid_shop_item_first_month IS NULL; "
    "UPDATE sid_new_day "
    "SET sid_shop_item_first_week = 0 WHERE sid_shop_item_first_week IS NULL; "
    # expanding quantity sold stats
    # if going to assign some quantity sold value to each first shop-item using
    # some sampling or modeling, need to then join those values onto the
    ...
    "ALTER TABLE sid_new_day "
    "ADD COLUMN sid_shop_item_expand_qty_max smallint, "
    "ADD COLUMN sid_shop_item_expand_qty_mean real, "
    "ADD COLUMN sid_shop_item_expand_qty_min smallint, "
    "ADD COLUMN sid_shop_item_expand_qty_mode smallint, "
    "ADD COLUMN sid_shop_item_expand_qty_median real; "
    "UPDATE sid_new_day nd "
    ...
    "avg(sid_shop_item_qty_sold_day) AS sid_shop_item_expand_qty_mean, "
    ...
    "UPDATE sid_new_day "
    "SET sid_shop_item_expand_qty_max = 0 WHERE sid_shop_item_expand_qty_max IS NULL; "
    "UPDATE sid_new_day "
    "SET sid_shop_item_expand_qty_mean = 0 WHERE sid_shop_item_expand_qty_mean IS NULL; "
    "UPDATE sid_new_day "
    "SET sid_shop_item_expand_qty_min = 0 WHERE sid_shop_item_expand_qty_min IS NULL; "
    "UPDATE sid_new_day "
    "SET sid_shop_item_expand_qty_mode = 0 WHERE sid_shop_item_expand_qty_mode IS NULL; "
    "UPDATE sid_new_day "
    "SET sid_shop_item_expand_qty_median = 0 WHERE sid_shop_item_expand_qty_median IS NULL; "
    # gap between sales stats
    "ALTER TABLE sid_new_day "
    "ADD COLUMN sid_shop_item_date_avg_gap_bw_sales real, "
    "ADD COLUMN sid_shop_item_date_max_gap_bw_sales int, "
    "ADD COLUMN sid_shop_item_date_min_gap_bw_sales int, "
    "ADD COLUMN sid_shop_item_date_median_gap_bw_sales real, "
    "ADD COLUMN sid_shop_item_date_mode_gap_bw_sales int, "
    "ADD COLUMN sid_shop_item_date_std_gap_bw_sales real; "
    "UPDATE sid_new_day nd "
    ...
    "max(shop_item_days_since_prev_sale_lmtd) AS sid_shop_item_date_max_gap_bw_sales, "
    "min(shop_item_days_since_prev_sale_lmtd) AS sid_shop_item_date_min_gap_bw_sales, "
    "percentile_cont(0.5) WITHIN GROUP (ORDER BY shop_item_days_since_prev_sale_lmtd) AS sid_shop_item_date_median_gap_bw_sales, "
    "mode() WITHIN GROUP (ORDER BY shop_item_days_since_prev_sale_lmtd) AS sid_shop_item_date_mode_gap_bw_sales, "
    "stddev_pop(shop_item_days_since_prev_sale_lmtd) AS sid_shop_item_date_std_gap_bw_sales "
    "FROM ("
    "SELECT shop_id, item_id, "
    ...
    "UPDATE sid_new_day "
    "SET sid_shop_item_date_avg_gap_bw_sales = 0 WHERE sid_shop_item_date_avg_gap_bw_sales IS NULL; "
    "UPDATE sid_new_day "
    "SET sid_shop_item_date_max_gap_bw_sales = 0 WHERE sid_shop_item_date_max_gap_bw_sales IS NULL; "
    "UPDATE sid_new_day "
    "SET sid_shop_item_date_min_gap_bw_sales = 0 WHERE sid_shop_item_date_min_gap_bw_sales IS NULL; "
    "UPDATE sid_new_day "
    "SET sid_shop_item_date_median_gap_bw_sales = 0 WHERE sid_shop_item_date_median_gap_bw_sales IS NULL; "
    "UPDATE sid_new_day "
    "SET sid_shop_item_date_mode_gap_bw_sales = 0 WHERE sid_shop_item_date_mode_gap_bw_sales IS NULL; "
    "UPDATE sid_new_day "
    "SET sid_shop_item_date_std_gap_bw_sales = 0 WHERE sid_shop_item_date_std_gap_bw_sales IS NULL; "
    # rolling 7-day quantity sold stats
    "ALTER TABLE sid_new_day "
    "ADD COLUMN sid_shop_item_rolling_7d_avg_qty real, "
    "ADD COLUMN sid_shop_item_rolling_7d_max_qty smallint, "
    "ADD COLUMN sid_shop_item_rolling_7d_min_qty smallint, "
    "ADD COLUMN sid_shop_item_rolling_7d_median_qty real, "
    "ADD COLUMN sid_shop_item_rolling_7d_mode_qty smallint; "
    "UPDATE sid_new_day nd "
    ...
    "UPDATE sid_new_day "
    "SET sid_shop_item_rolling_7d_avg_qty = 0 WHERE sid_shop_item_rolling_7d_avg_qty IS NULL; "
    "UPDATE sid_new_day "
    "SET sid_shop_item_rolling_7d_max_qty = 0 WHERE sid_shop_item_rolling_7d_max_qty IS NULL; "
    "UPDATE sid_new_day "
    "SET sid_shop_item_rolling_7d_min_qty = 0 WHERE sid_shop_item_rolling_7d_min_qty IS NULL; "
    "UPDATE sid_new_day "
    "SET sid_shop_item_rolling_7d_median_qty = 0 WHERE sid_shop_item_rolling_7d_median_qty IS NULL; "
    "UPDATE sid_new_day "
    "SET sid_shop_item_rolling_7d_mode_qty = 0 WHERE sid_shop_item_rolling_7d_mode_qty IS NULL; "
    # last quantity sold
    "ALTER TABLE sid_new_day "
    "ADD COLUMN sid_shop_item_last_qty_sold smallint; "
    "UPDATE sid_new_day nd "
    ...
    "UPDATE sid_new_day "
    "SET sid_shop_item_last_qty_sold = 0 WHERE sid_shop_item_last_qty_sold IS NULL; "
    # expanding average demand interval (ADI)
    "ALTER TABLE sid_new_day "
    "ADD COLUMN sid_shop_item_expanding_adi real; "
    "UPDATE sid_new_day "
    ...
    "UPDATE sid_new_day "
    "SET sid_shop_item_expanding_adi = 0 WHERE sid_shop_item_expanding_adi IS NULL; "
    # expanding CV2 of quantity sold
    "ALTER TABLE sid_new_day "
    "ADD COLUMN sid_expand_cv2_of_qty real; "
    "UPDATE sid_new_day nd "
    ...
    "UPDATE sid_new_day "
    "SET sid_expand_cv2_of_qty = 0 WHERE sid_expand_cv2_of_qty IS NULL; "
    # days since max quantity sold
    "ALTER TABLE sid_new_day "
    "ADD COLUMN sid_days_since_max_qty_sold int; "
    "UPDATE sid_new_day nd "
    "SET sid_days_since_max_qty_sold = dsm.sid_days_since_max_qty_sold "
    "FROM ("
    "SELECT shop_id, item_id, %(curr_date)s - sale_date::date AS sid_days_since_max_qty_sold "
    "FROM shop_item_dates "
    ...
    "UPDATE sid_new_day "
    "SET sid_days_since_max_qty_sold = 0 WHERE sid_days_since_max_qty_sold IS NULL; "
    # difference between last and previous quantities sold
    "ALTER TABLE sid_new_day "
    "ADD COLUMN sid_shop_item_date_diff_bw_last_and_prev_qty smallint; "
    "WITH rns AS "
    ...
    "UPDATE sid_new_day "
    "SET sid_shop_item_date_diff_bw_last_and_prev_qty = 0 WHERE sid_shop_item_date_diff_bw_last_and_prev_qty IS NULL; "
    ...
    "ALTER TABLE sid_new_day "
    "ADD COLUMN sid_qty_mean_abs_dev real; "
    "WITH abs_devs AS ("
    # "SELECT shop_id, item_id, "
    ...
    "UPDATE sid_new_day "
    "SET sid_qty_mean_abs_dev = 0 WHERE sid_qty_mean_abs_dev IS NULL; "
    ...
    "ALTER TABLE sid_new_day "
    "ADD COLUMN sid_qty_median_abs_dev real; "
    "WITH medians AS ("
    # "SELECT shop_id, item_id, "
    ...
    "UPDATE sid_new_day "
    "SET sid_qty_median_abs_dev = 0 WHERE sid_qty_median_abs_dev IS NULL; "
    ...
    "ALTER TABLE sid_new_day "
    "ADD sid_item_category_id smallint; "
    "WITH ics AS ("
    "SELECT item_id, i_item_category_id "
    "FROM items) "
    "UPDATE sid_new_day nd "
    "SET sid_item_category_id = ics.i_item_category_id "
    "FROM ics "
    "WHERE nd.item_id = ics.item_id; "
    "ALTER TABLE sid_new_day "
    "ADD COLUMN sid_cat_sold_at_shop_before_day_flag smallint; "
    "WITH scq AS ("
    ...
    "UPDATE sid_new_day "
    "SET sid_cat_sold_at_shop_before_day_flag = 0 WHERE sid_cat_sold_at_shop_before_day_flag IS NULL; "
    ...
    "WHERE nd.shop_id = scq.shop_id AND nd.sid_item_category_id = scq.sid_item_category_id; "
    "UPDATE sid_new_day "
    "SET sid_shop_cat_qty_sold_last_7d = 0 WHERE sid_shop_cat_qty_sold_last_7d IS NULL; "
    ...
    "UPDATE sid_new_day "
    "SET sid_days_since_available = 0 WHERE sid_days_since_available IS NULL; "
)
